...
export const cloneDesignsToArtworkVersionService = async ({
	userId,
	artworkVersionId,
	designs,
}: IArtworkVersionDesignCloneSubmission): Promise<IDesignsClonedResponse> => {
	try {
...
const prepareDesignCreateData = ({
	...
	const validatedDesignCreateDataList: IArtworkVersionDesignCreateData[] = []
...
const prepareDesignCreatePromises = ({
	...
	validatedDesignCreateDataList: IArtworkVersionDesignCreateData[]
