...
import { type IDesignFillUpdateStyleSubmission } from './definitions.update'
...
export const updateDesignFillStyleService = async ({
	userId,
	id,
	style,
}: IDesignFillUpdateStyleSubmission): Promise<IDesignUpdatedResponse> => {
	try {
