...
INSERT INTO "new_Design" ("artworkVersionId", "attributes", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "selected", "type", "visible") SELECT "artworkVersionId", coalesce("attributes", '{}') AS "attributes", "createdAt", "id", "layerId", "nextId", "ownerId", "prevId", "selected", "type", "visible" FROM "Design";
DROP TABLE "Design";
